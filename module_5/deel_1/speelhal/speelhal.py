...
VAT_CODE_H = 'H'
VAT_CODE_L = 'L'
# opvragen wat de klant wil bestellen
print("SPEELHAL-ENTREE-KASSA")

if input_yes_no("Wilt u bestellen?(j/n)") in NO_OPTIONS:
...
vr_vip_ordered = input_yes_no("Ook VR-VIP seats?(j/n)") in YES_OPTIONS
...
vat_invoice = input_yes_no("Wilt u een factuur met BTW specificatie?(j/n)") in YES_OPTIONS
